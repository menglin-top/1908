...
<form class="form-horizontal" role="form" action="{{url('title/store')}}" method="post" enctype="multipart/form-data">
  @csrf
  <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">文章标题</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" name="head" id="firstname" placeholder="文章标题">
  ...
  <div class="form-group">
   ...
   <div class="radio">
    <label>
        <input type="radio" name="is_zhong" id="optionsRadios1" value="普通" > 普通
    </label>
    <label>
        <input type="radio" name="is_zhong" id="optionsRadios1" value="置顶" > 置顶
    </label>
  ...
  <div class="form-group">
   ...
   <div class="radio">
    <label>
        <input type="radio" name="is_show" id="optionsRadios1" value="1" > 显示
    </label>
    <label>
        <input type="radio" name="is_show" id="optionsRadios1" value="2" > 不显示
    </label>
